(ns metosin.clj-helidon.media-context-builder-helper-test
  (:require [clojure.test :refer [deftest is testing]]
            [matcher-combinators.test]
            [metosin.clj-helidon.media-support.json :as json]
            [metosin.clj-helidon.media-support.transit :as transit]
            [metosin.clj-helidon.media-support.edn :as edn]
            [metosin.clj-helidon.media-context-builder-helper :as mcbh])
  (:import (io.helidon.http.media MediaContext)))


(def coerce-media-context #'metosin.clj-helidon.media-context-builder-helper/coerce-media-context)
...
(def coerce-media-supports #'metosin.clj-helidon.media-context-builder-helper/coerce-media-supports)
